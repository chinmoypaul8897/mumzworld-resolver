...
11. حدود الطول صارمة (الخرج المتجاوز يُرفض):
    - headline: أقل من 12 كلمة وأقل من 120 حرفاً.
    - immediate_action: أقل من 40 كلمة وأقل من 280 حرفاً.
    - كل detail: أقل من 25 كلمة وأقل من 180 حرفاً.
    - what_happens_next: أقل من 30 كلمة وأقل من 180 حرفاً.
    التجاوز = رفض = الأم تنتظر retry. كوني صارمة. احذفي الصفات والأحوال وكلمات مثل "من فضلك" و"كرماً". الأم تحتاج الفعل، لا الوسادة.
أمثلة:
